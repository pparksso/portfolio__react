...
const Profile = () => {
    return (
        <section className="w-full pb-10 border-b border-gray-200">
            <div className="flex items-end justify-between w-full mb-12">
                <h1 className="relative pl-3 text-4xl font-bold before:absolute before:block before:w-2 before:h-full before:bg-emerald-400 before:top-1/2 before:-translate-y-1/2 before:left-0">
            ...
            <div className="flex items-center">
                ...
                <div className="">
                    ...
                    <div className="">
                        <h2 className="text-2xl font-bold text-emerald-500">Skill</h2>
                        <div className="flex items-center">
