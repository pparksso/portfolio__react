        ...
        func: [
            {
                ...
                desc: 'CRUD 기능과 게시판 페이지의 페이지네이션을 공통 컴포넌트로 구현하고, 이를 공통 store에서 관리했습니다. \n또한, 모든 리스트에서 공통으로 사용되는 검색 영역을 공통 컴포넌트로 개발하여 store 변수를 통해 효율적으로 관리했습니다.',
                img: '',
            },
            {
                title: '블록 형태 에디터 내 붙여넣기 기능',
